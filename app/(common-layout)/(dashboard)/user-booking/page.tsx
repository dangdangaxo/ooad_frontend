    ...
    <div className="border border-neutral-40 p-4 p-sm-6 xl:p-8 rounded-2xl">
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 lg:col-span-6 xl:col-span-4">
          ...
          <h5 className="mb-0 font-medium"> {prop.userBook}</h5>
        </div>
      </div>
    </div>
  </li>
            ...
            <Tab.Panels>
              <Tab.Panel className="tab-pane fade show active" id="upcoming">
                ...
                <ul className="flex flex-col gap-4">
                  <BookedHotel
                    travelTo="Ha noi to HCM"
                    bookingId={123213131}
                    travelClass="Business"
                    departureTime="Tue 09 Jan 12:00 AM"
                    arrivalTime="Tue 06 Aug 4:00 PM"
                    userBook=" Phương Minh"
                  />
                </ul>
              </Tab.Panel>
