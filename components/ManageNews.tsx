...
const ManageNews = ({ item }: any) => {
  const [favorite, setFavorite] = useState(false);
  const { id, img, price, title } = item;
  return (
    <li key={id}>
      <div className="p-2 rounded-2xl flex flex-col lg:flex-row bg-[var(--bg-2)]">
          ...
          <div className="property-card__body">
            <div className="flex justify-between mb-2">
              ...
              <div className="flex items-center shrink-0">
                {/* <button className="btn-outline  font-semibold">Adjust</button> */}
                <Link
                  href="hotel-listing-details"
                ...
                <button className="btn-outline  font-semibold ml-5">
                  Delete
                </button>
              </div>
            </div>
